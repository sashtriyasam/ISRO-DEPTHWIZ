...
| 15  | Solar-shadow height extraction       | PASS                                  | `depthwizard.solar` package: sun-angle resolver, Otsu shadow detector, trig height kernel, pipeline stage, and UI panel | `src/depthwizard/solar/`, `tests/solar/` (29 passed), `SolarShadowPanel.tsx`                  | None                                                                            | Shivam         |
