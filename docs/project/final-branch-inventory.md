...
| --------------------------------------------------- | ------- | ------------------------------ | ---------- | --------------------------------------------------------------------------------- | ----------------------- | -------------------------------------------- |
| `main`                                              | Shivam  | Release baseline               | `02a0650`  | HEAD (PR #3 M17 docs merged)                                                      | **RELEASE**             | —                                            |
| `feat/shivam-release-closure`                       | Shivam  | Release closure (current work) | —          | Based on current main (`02a0650`); supersedes `feat/shivam-final-release-control` | **RELEASE WORK**        | Open PR, do not auto-merge                   |
...
| `feat/shravan-final-ml-release`                     | Shravan | ML release evidence (M17)      | `6de12b8`  | Ancestry repaired; `docs/final-ml-candidate.md` merged to main via PR #3          | **ACTIVE RESEARCH**     | Keep — do not merge further (research track) |
| `archive/shravan-final-ml-release-pre-ancestry-fix` | Shravan | Pre-repair backup pointer      | `b920772`  | Backup only                                                                       | **HISTORICAL**          | Keep (backup)                                |
| `feat/shivam-release-closure`                       | Shivam  | Release closure (this branch)  | —          | Based on current main (`02a0650`)                                                 | **RELEASE WORK**        | Open PR, do not auto-merge                   |
