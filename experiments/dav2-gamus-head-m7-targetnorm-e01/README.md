# dav2-gamus-head-m7-targetnorm-e01

Frozen DA-V2-Small + lightweight head on GAMUS with zscore target normalization (research).
...
- Best val MAE: 5.5358 m @ epoch 8 (selection on VAL only; test unused).
- Target mode: zscore
